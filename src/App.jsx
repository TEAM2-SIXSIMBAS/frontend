...
function HomePage() {
    ...
    const previewRequest = (cat, srt, uiPage) => {
        ...
        const url = `${API_BASE}/partnership-info?category=${encodeURIComponent(
            catParam
        )}&sort=${encodeURIComponent(srt)}&page=${oneBased}`;
